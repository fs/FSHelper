#
#  Be sure to run `pod spec lint FSHelpers+Swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.exclude_files = "Swift/Test classes"
  ...
  s.source_files  = "Swift/Helpers", "Swift/Helpers/**/*.{swift}"
