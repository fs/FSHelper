...
class FSHelperTests: XCTestCase {
    ...
    func testScreenTypeInchInitWithSize () {
        ...
        let type3_5     = FSScreenTypeInch(size: size3_5)
        let type4       = FSScreenTypeInch(size: size4)
        let type4_7     = FSScreenTypeInch(size: size4_7)
        let type5_5     = FSScreenTypeInch(size: size5_5)
        
        XCTAssertEqual(FSScreenTypeInch._3_5,     type3_5,    "Must be 3.5 inch type")
        XCTAssertEqual(FSScreenTypeInch._4,       type4,      "Must be 4 inch type")
        XCTAssertEqual(FSScreenTypeInch._4_7,     type4_7,    "Must be 4.7 inch type")
        XCTAssertEqual(FSScreenTypeInch._5_5,     type5_5,    "Must be 5.5 inch type")
        
        //Test default
        let defaultType = FSScreenTypeInch(size: CGSizeZero)
        XCTAssertEqual(FSScreenTypeInch._4, defaultType, "Default type must be 4 inch type")
    }
    ...
    func testGetScreenValue () {
        ...
        let result3_5     = FSScreenTypeInch._3_5 .getScreenValue(value3_5: value3_5, value4: value4, value4_7: value4_7, value5_5: value5_5) as! CGFloat
        let result4       = FSScreenTypeInch._4   .getScreenValue(value3_5: value3_5, value4: value4, value4_7: value4_7, value5_5: value5_5) as! CGFloat
        let result4_7     = FSScreenTypeInch._4_7 .getScreenValue(value3_5: value3_5, value4: value4, value4_7: value4_7, value5_5: value5_5) as! CGFloat
        let result5_5     = FSScreenTypeInch._5_5 .getScreenValue(value3_5: value3_5, value4: value4, value4_7: value4_7, value5_5: value5_5) as! CGFloat
    ...
    func testGetScreenCGFloat () {
        ...
        let result3_5     = FSScreenTypeInch._3_5 .getScreenCGFloat(value3_5: value3_5, value4: value4, value4_7: value4_7, value5_5: value5_5)
        let result4       = FSScreenTypeInch._4   .getScreenCGFloat(value3_5: value3_5, value4: value4, value4_7: value4_7, value5_5: value5_5)
        let result4_7     = FSScreenTypeInch._4_7 .getScreenCGFloat(value3_5: value3_5, value4: value4, value4_7: value4_7, value5_5: value5_5)
        let result5_5     = FSScreenTypeInch._5_5 .getScreenCGFloat(value3_5: value3_5, value4: value4, value4_7: value4_7, value5_5: value5_5)
    ...
    func testGetScreenCGFloatWithout3_5 () {
        ...
        let result4       = FSScreenTypeInch._4   .getScreenCGFloat(value4: value4, value4_7: value4_7, value5_5: value5_5)
        let result4_7     = FSScreenTypeInch._4_7 .getScreenCGFloat(value4: value4, value4_7: value4_7, value5_5: value5_5)
        let result5_5     = FSScreenTypeInch._5_5 .getScreenCGFloat(value4: value4, value4_7: value4_7, value5_5: value5_5)
