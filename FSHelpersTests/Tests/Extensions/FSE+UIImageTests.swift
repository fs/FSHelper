...
class FSE_UIImageTests: XCTestCase {
    ...
    */
    ...
    func testInitWithDataAndSize () {
        ...
        let bitmap = FSBitmap(data: data, size: (width, height))
    ...
    func testInitWithSize () {
        ...
        let bitmap = FSBitmap(size: (width, height))
    ...
    func testGetUIImage () {
        let bitmap = FSBitmap(size: (5, 5))
        for y in 0 ..< 5 {
            for x in 0 ..< 5 {
                bitmap.setPixel(FSBitmapPixel(color: self.etalonColors[y][x]), point: (x, y))
            }
        }
    ...
    func testGetPixel () {
        ...
        for y in 0 ..< height {
            for x in 0 ..< width {
                let etalon  = FSBitmapPixel(value: data[width*y + x])
    ...
    func testSetPixel () {
        ...
        for y in 0 ..< height {
            for x in 0 ..< width {
                ...
                bitmap.setPixel(FSBitmapPixel(value: etalon), point: (x, y))
